        ...
        <>
            <div className="card p-8 bg-gray-800 bg-opacity-30 rounded-lg" key={key}>
                <div className="info ">
                    ...
                    <p className="text-gray-400">{t('page_education.location')}: {education.location}</p>
                    <p className="text-gray-400">{t('page_education.start')}: {education.start}</p>
                    ...
                    {education.intermediate_title && (
                        <>
                            ...
                            <p className="text-gray-400">{t('page_education.end')}: {education.intermediate_title.end}</p>
                            {education.intermediate_title.CGPA && (<p className="text-gray-400">{t('page_education.CGPA')}: {education.intermediate_title.CGPA}</p>)}
                        </>
                    )}
                    ...
                    {education.final_title && (
                        <>
                            ...
                            <p className="text-gray-400">{t('page_education.end')}: {education.final_title.end}</p>
                            {education.final_title.title && (<p className="text-gray-400">{t('page_education.CGPA')}: {education.final_title.CGPA}</p>)}
                        </>
                    )}
                </div>
            </div>

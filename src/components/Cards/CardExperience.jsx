        ...
        <>
            <div className="card p-8" key={key}>
                <div className="info">
                    ...
                    <p className="text-gray-600">{t('page_experience.location')}: {experience.location}</p>
                    <p className="text-gray-600">{t('page_experience.start')}: {experience.start}</p>
                    <p className="text-gray-600">{t('page_experience.end')}: {experience.end}</p>
                </div>
            </div>
        </>
    );
